package com.sensetime.qinhaihang_vendor.ttsdemo.util;
...
public class OfflineResource {
    ...
    public String getTextFilename() {
        return destPath + "/bd_etts_text.dat";
    }

    public String getModelFilename(String voiceType){
        String model;
